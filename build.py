...
class BuildExe:
    def __init__(self):
        ...
        # Name of program
        self.project_name = "Warrior of Drisnya"
        ...
        self.license = "Drisnya License"

        # Auhor of program
        self.author_name = "Iwan Silin"
        self.author_email = "ivan.k.silin@gmail.com"
        self.copyright = "Copyright (c) 2017 Me."

        # Description
        self.project_description = "Game about warrior of Drisnya"

        # Icon file (None will use pygame default icon)
        self.icon_file = None

        # Extra files/dirs copied to game
        self.extra_datas = ['src', 'save']
